import { CallbackQuery, Chat, ChatMemberUpdated, ChosenInlineResult, InlineQuery, Message, Poll, PollAnswer, PreCheckoutQuery, ShippingQuery, Update } from "./generated/components.interfaces";
...
/** All Update Type */
export declare type UpdateSchema = UpdateSchema.CallbackQueryUpdate | UpdateSchema.ChannelPostUpdate | UpdateSchema.ChatMemberUpdate | UpdateSchema.ChosenInlineResultUpdate | UpdateSchema.EditedChannelPostUpdate | UpdateSchema.EditedMessageUpdate | UpdateSchema.InlineQueryUpdate | UpdateSchema.MessageUpdate | UpdateSchema.MyChatMemberUpdate | UpdateSchema.PollAnswerUpdate | UpdateSchema.PollUpdate | UpdateSchema.PreCheckoutQueryUpdate | UpdateSchema.ShippingQueryUpdate;
export declare type UpdateType = 'callback_query' | 'channel_post' | 'chat_member' | 'chosen_inline_result' | 'edited_channel_post' | 'edited_message' | 'inline_query' | 'message' | 'my_chat_member' | 'poll_answer' | 'poll' | 'pre_checkout_query' | 'shipping_query';
export declare type UpdateEvent = Record<UpdateType, any>;
