...
export interface SmartActionSchema {
    ...
    reply(
        msg: string,
        parse_mode?: string,
        markup?: InlineKeyboardMarkup | ReplyKeyboardRemove | ReplyKeyboardMarkup | ForceReply | undefined,
...
export type responseTree = ( msg?: any, trigger?: SmartActionSchema ) => void

// router
export type RouterSchemaSub = {
    path: string | RegExp,
    event: UpdateType,
    action: EventReceiver<SmartActionSchema>
}

export type RouterSchema = RouterSchemaSub[]